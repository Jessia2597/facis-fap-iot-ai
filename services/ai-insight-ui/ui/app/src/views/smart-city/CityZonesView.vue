...
.summary-chip--green .summary-chip__val { color: var(--color-success-dark); }
.summary-chip--yellow .summary-chip__val { color: var(--color-warning-dark); }
.summary-chip--red .summary-chip__val { color: var(--color-danger-dark); }
